...
RSpec.describe TestsController, type: :controller do
  ...
  describe "POST" do
    it "creats new test" do
      params = {"name"=>"a", "date(1i)"=>Time.now.utc.year, "date(2i)"=>Time.now.utc.month, "date(3i)"=>Time.now.utc.day, "duration(1i)"=>"2016", "duration(2i)"=>"10", "duration(3i)"=>"10", "duration(4i)"=>"12", "duration(5i)"=>"57"}
